...
fixed_cols <- c("id", "year", "month", "day", "season", "time_of_day", "date", "time",
                "lat", "lon", "swell", "beaufort", "home_screen", "effort", "species",
                "group", "behaviour", "distance_band", "shag_plumage", "scientific_name",
                "region_mainland", "region_islands", "dist_to_coast", "dist_to_mainland",
                "age", "note", "count", "distance_offshore")

# Get spp and sp-only column names
spp_cols <- setdiff(colnames(data_wide), fixed_cols)
sp_only_cols <- spp_cols[!grepl(pattern = "Unknown", x = spp_cols)]
...
plot_freq_occ
ggsave(plot_freq_occ,
       filename = "~/uniwersity/Postgrad Otago/Project/Data/foveaux_seabirds/results/plot_monthly_occurrence.jpg",
       width = 32, height = 12.5, units = "cm", dpi = 300)
...
ggsave(plot_freq_num,
       filename = "~/uniwersity/Postgrad Otago/Project/Data/foveaux_seabirds/results/plot_monthly_abundance.jpg",
       width = 32, height = 12.5, units = "cm", dpi = 300)
...
## Frequency of occurrence and numeric frequency, by SEASON ####
  ...
  ggsave(plot_seas_freq_occ,
         filename = "~/uniwersity/Postgrad Otago/Project/Data/foveaux_seabirds/results/plot_seasonal_occurrence.jpg",
         width = 16, height = 12.5, units = "cm", dpi = 300)
  ...
  plot_freq_num
  ggsave(plot_freq_num,
         filename = "~/uniwersity/Postgrad Otago/Project/Data/foveaux_seabirds/results/plot_relative_abundance.jpg",
         width = 16, height = 12.5, units = "cm", dpi = 300)
...
sp_abun_pct_filtered <- sp_abun_pct %>%
  dplyr::filter(species %in% c("Diving petrel", 
                               "Sooty shearwater", 
                               "Buller's mollymawk",
