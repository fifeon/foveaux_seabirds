...
df_birds <-
  ...
  dplyr::mutate(species = dplyr::case_when(
    species == "white_fronted_tern" ~ "white-fronted_tern",
    species == "southern_skua" ~ "brown_skua",
    species == "other_mollymawk" ~ "thalassarche_sp",
    species == "other_albatross" ~ "diomedea_sp",
    species == "gadfly_sp" ~ "pterodroma_sp",
    species == "prion_sp" ~ "pachyptila_sp",
    species == "giant_petrel_sp" ~ "macronectes_sp",
    species == "gull_sp" ~ "laridae",
    species == "other_petrel" ~ "procellariidae",
    species == "shag_sp" ~ "phalacrocoracidae",
    species == "shearwater_sp" ~ "procellariidae",
    species == "tern_sp" ~ "sternidae",
    species == "Thalassarche_sp" ~ "thalassarche_sp",
    species == "common_diving_petrel" ~ "pelecanoides_sp",
      #change other capital species names to lowcase
    TRUE ~ species
  ))
#--------------------------------------#
...
df_birds <-
  ...
  dplyr::mutate(species_nice_name = dplyr::case_when(
    ...
    species == "macronectes_sp" ~ "Unknown giant petrel",
    ...
    species == "procellariidae" ~ "Unknown petrel",
    ...
    species == "pterodroma_sp" ~ "Unknown (Pterodroma) petrel",
    ...
    species == "Fregetta_Pealeornis_sp" ~ "Unknown (Fregetta/Pealeornis) petrel",
    ...
    species == "pachyptila_sp" ~ "Unknown prion",
    species == "pelecanoides_sp" ~ "Diving petrel",
    ...
    species == "sternidae" ~ "Unknown tern",
    ...
    species == "phalacrocoracidae" ~ "Unknown shag",
...
#--------------------------------------#
{
  df_birds <-
    ...
    dplyr::mutate(scientific_name = dplyr::case_when(
      ...
      species == "royal_albatross_sp" ~ "Diomedea sp.",
      species == "diomedea_sp" ~ "Diomedeidae sp.",
      ...
      species == "thalassarche_sp" ~ "Thalassarche sp.",
      species == "Phoebetria_sp" ~ "Phoebetria sp.",
      species == "northern_giant_petrel" ~ "Macronectes halli",
      species == "southern_giant_petrel" ~ "Macronectes giganteus",
      species == "macronectes_sp" ~ "Macronectes sp.",
      ...
      species == "procellariidae" ~ "Procellariidae",
      ...
      species == "pterodroma_sp" ~ "Pterodroma sp.",
      ...
      species == "procellariidae" ~ "Procellariidae (shearwater) sp.",
      ...
      species == "Fregetta_Pealeornis_sp" ~ "Fregetta/Pealeornis sp.",
      ...
      species == "pachyptila_sp" ~ "Pachyptila sp.",
      species == "pelecanoides_sp" ~ "Pelecanoides sp",
      ...
      species == "skua_sp" ~ "Stercorarius sp.",
      ...
      species == "sternidae" ~ "Sternidae sp.",
      ...
      species == "phalacrocoracidae" ~ "Phalacrocoracidae sp.",
      ...
      species == "crested_penguin_spp" ~ "Eudyptes sp.",
      ...
      species == "fulmarine_sp" ~ "Procellariidae (fulmarine) sp.",
      species == "Procellaria_sp" ~ "Procellaria sp.",
...
dplyr::mutate(time_of_day = dplyr::case_when(
  id %in% c(2,3,12,13,22,23,32,33,37,38,47,48,55,56,69,70,81,82,90,91,98,99,106,107,
            6,7,16,17,26,27,41,42,61,62,85,86,94,100,101,10,20,30,36,45,53,67,79,96,104,114) ~ 'morning',
  id %in% c(57,58,71,72,51,52,63,64,75,76) ~ 'midday',
  id %in% c(1,11,21,31,46,54,68,80,89,97,105,4,5,14,15,24,25,34,35,39,40,49,50,59,60,73,74,
            83,84,92,93,108,109,8,9,18,19,28,29,43,44,65,66,77,78,87,88,95,102,103,110,111,112,113) ~ 'evening',
